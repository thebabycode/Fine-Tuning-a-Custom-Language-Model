...
openai.api_key = "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"
...
resp = file_upload('halfscenarios.jsonl')
finetune_model(resp['id'], 'halfscenarios_model', 'davinci')
